...
setup(
    ...
    entry_points={
        'console_scripts': [
    'pid_control_node5 = fusion_CP_Consensus.pid_control_node5:main',
    ...
    'local_path_node5 = fusion_CP_Consensus.local_path_node5:main',
    ...
    'global_path_node5 = fusion_CP_Consensus.global_path_node5:main',
    ...
    'decision_node5 = fusion_CP_Consensus.decision_node5:main',
