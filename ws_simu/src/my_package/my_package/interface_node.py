#Node pour faire l'interface entre les positions dans le simulateur et le reste des nodes
#Elle sert à transformer les positions envoyées par le simulateur et les publiées sur les topic lus par les nodes
