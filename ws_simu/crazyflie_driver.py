...
class CrazyflieDriver:
    ...
    def init(self, webots_node, properties):
        ...
        # 🔹 Récupérer le nom du robot depuis Webots
        robot_name = self.robot.getName()

        # 🔹 Topics spécifiques à ce robot
        cmd_topic = f'/{robot_name}/cmd_vel'
        scan_topic = f'/{robot_name}/scan'

        # 🔹 Souscription et publication ROS2
        ...
        self.node.get_logger().info(f"✅ Initialized driver for {robot_name}, listening on {cmd_topic}")
